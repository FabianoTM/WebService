 ...
 * 
 */
@WebServiceClient(name = "HelloWebService", targetNamespace = "http://ws.exemplo.ftm.com.br/", wsdlLocation = "http://localhost:8082/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICE_QNAME = new QName("http://ws.exemplo.ftm.com.br/", "HelloWebService");
    ...
    public HelloWeb getHelloWebPort() {
        return super.getPort(new QName("http://ws.exemplo.ftm.com.br/", "HelloWebPort"), HelloWeb.class);
    }
    ...
    public HelloWeb getHelloWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.exemplo.ftm.com.br/", "HelloWebPort"), HelloWeb.class, features);
    }
